#!/usr/bin/env node
/**
 * Standalone 24h autonomous cycle for Haram AI Agent.
 *
...
const BRAIN_DIR = (process.env.BRAIN_DIR || path.join(os.homedir(), '.haram-ai-brain')).replace(/^~/, os.homedir());
...
# */30 * * * * /usr/local/bin/node /path/to/cycle.js >> ~/.haram-ai-brain/cycle.log 2>&1
